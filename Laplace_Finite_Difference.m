...
for i = 1:region_size
    ...
    for j = 1:region_size
        ...
        elseif (i == 1 && j == 1)
           ...
           potential(i, j) = (potential(i + 1, j) + potential(i, j + 1) + BCleft)/3;
        ...
        elseif(i == region_size && j == 1)
           ...
           potential(i, j) = (potential(i - 1, j) + potential(i, j + 1) + BCright)/4;
        ...
        elseif(j == 1 && i ~= 1 && i ~= region_size)
           ...
           potential(i, j) = (potential(i + 1, j) + potential(i - 1, j) + potential(i, j + 1))/3;
